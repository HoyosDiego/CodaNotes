import { fetchNotes, getUser, initDB, INote, NoteInput, saveNote, saveUser, User, UserInput } from '@/services';
import { isDbLoadedAtom, notesListAtom, userAtom } from '@/state';
